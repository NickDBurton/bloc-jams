...
var selectSong = function(direction) {
...
var updatePlayerBarSong = function() {
  ...
  $('.currently-playing .artist-song-mobile').text(currentSongFromAlbum.title + " - " + currentAlbum);
  $('.main-controls .play-pause').html(playerBarPauseButton);
};
...
$(document).ready(function() {
  ...
  $previousButton.click(selectSong('previous'));
  $nextButton.click(selectSong('next'));
  });
